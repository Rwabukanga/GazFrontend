                ...
                <v-card>
                    ...
                    <v-card-text>
                        <v-form>
                            ...
                            <v-text-field label="Phone Number" v-model="user.phonenumber" :rules="[rules.required]"
                                required></v-text-field>

                            <v-text-field label="E-mail" v-model="user.email" :rules="[rules.required, rules.email]"
                                required></v-text-field>

                            <v-text-field label="National ID" v-model="user.nationalid" :rules="[rules.required]"
                                required></v-text-field>
                            ...
                            <v-text-field label="Date of Birth" v-model="user.dateofbirth" :rules="[rules.required]"
